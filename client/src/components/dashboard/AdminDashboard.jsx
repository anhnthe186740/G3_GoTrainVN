...
export function AdminDashboard() {
  ...
  return (
    <div className="flex min-h-screen bg-[#f7f9fb] text-[#191c1e] font-body-md overflow-x-hidden">
      {/* Sidebar Navigation */}
      <aside className="hidden md:flex flex-col w-72 bg-white border-r border-[#bec7d4]/30 sticky top-0 h-screen z-40 transition-all duration-300">
        <div className="p-6">
      ...
      <main className="flex-1 flex flex-col min-w-0 bg-[#f7f9fb]">
        {/* Header / Top Bar */}
        <header className="glass-panel sticky top-0 z-30 flex items-center justify-between px-8 py-4 border-b border-[#bec7d4]/20 shadow-sm">
