  ...
  return (
    <div className="min-h-screen bg-[#f7f9fb] pb-12">
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12 mt-8 space-y-6">
        ...
        {/* Blog section */}
        <div className="bg-white rounded-2xl border border-[#bec7d4]/20 shadow-sm overflow-hidden p-6 space-y-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              <h2 className="font-bold text-[#191c1e] flex items-center gap-2 text-lg">
                <span className="material-symbols-outlined text-[#00629d]">
                  rate_review
                </span>
              ...
              <p className="text-xs text-[#6f7883] mt-1">
                Khám phá những câu chuyện, kinh nghiệm du lịch bằng tàu hỏa và
                tin tức mới nhất từ GoTrain VN.
              </p>
            </div>
            <button
              onClick={() => setIsWriteModalOpen(true)}
              className="flex items-center gap-2 bg-[#00629d] hover:bg-[#00629d]/90 text-white px-4 py-2 rounded-xl font-semibold text-xs transition-all shadow-sm"
            >
          ...
          {blogsLoading ? (
            <div className="py-12 flex flex-col items-center gap-3">
              <div className="w-8 h-8 border-3 border-[#00629d] border-t-transparent rounded-full animate-spin" />
              <p className="text-xs text-[#6f7883]">Đang tải các bài viết...</p>
            </div>
          ) : blogs.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {blogs.slice(0, 3).map((post) => (
                <div
                  ...
                  className="group cursor-pointer bg-slate-50 hover:bg-white rounded-2xl border border-slate-100 hover:border-[#00629d]/20 p-5 transition-all duration-300 hover:shadow-md flex flex-col justify-between h-48"
                >
                  <div className="space-y-2">
                    <h3 className="font-bold text-slate-800 group-hover:text-[#00629d] transition-colors text-sm line-clamp-2 leading-snug">
                      {post.title}
                    </h3>
            ...
            <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl overflow-hidden max-h-[85vh] flex flex-col animate-in fade-in zoom-in-95 duration-200">
              ...
              <div className="px-6 py-5 border-b border-slate-100 flex items-start justify-between gap-4">
                <div className="space-y-1">
                  ...
                  <h3 className="font-extrabold text-[#191c1e] text-lg leading-snug mt-1">
                    {selectedBlog.title}
                  </h3>
              ...
              {/* Content Body */}
              <div className="p-6 overflow-y-auto space-y-4 text-slate-700 leading-relaxed text-sm whitespace-pre-wrap max-h-[50vh] font-sans">
            ...
            <div className="bg-white rounded-3xl shadow-2xl w-full max-w-xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
              ...
              <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
                ...
                <button
                  ...
                  className="w-8 h-8 flex items-center justify-center rounded-xl hover:bg-slate-100 transition-colors text-[#6f7883]"
                >
                  <span className="material-symbols-outlined text-[20px]">
                    close
                  </span>
              ...
              <form onSubmit={handleCreateBlog}>
                <div className="p-6 space-y-4 font-sans">
                  <div className="space-y-1">
                    ...
                    <input
                      type="text"
                      required
                      placeholder="Ví dụ: Kinh nghiệm đi tàu Hà Nội - Lào Cai chi tiết từ A-Z"
                      value={newBlogTitle}
                  ...
                  <div className="space-y-1">
                    ...
                    <textarea
                      required
                      placeholder="Nhập nội dung chia sẻ chi tiết của bạn tại đây..."
                      rows={6}
                ...
                {/* Action Buttons */}
                <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex justify-end gap-2 font-sans">
                  <button
                    type="button"
                    onClick={() => {
                      setIsWriteModalOpen(false);
                    ...
                    className="border border-slate-200 hover:bg-slate-100 text-slate-700 px-5 py-2.5 rounded-xl font-semibold text-xs transition-all"
                  >
                    Hủy bỏ
                  </button>
                  <button
                    ...
                    className="flex items-center gap-1.5 bg-[#00629d] hover:bg-[#00629d]/90 text-white px-5 py-2.5 rounded-xl font-semibold text-xs transition-all shadow-sm disabled:opacity-50"
                  >
                    {blogSubmitting ? (
